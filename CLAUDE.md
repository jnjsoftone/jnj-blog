...
**Key Concept**: This is a template with placeholder variables (e.g., `blog`, `${PORT_1}`) that get substituted during project creation via `create-project.sh`.
...
**Project Variables**:
- `blog` → Actual project name (e.g., "my-web-app")
- `자동화 블로그 플랫폼` → Project description
...
- `1.231.118.217`, `1.231.118.217` → Platform database hosts
...
5. **Modify template placeholders** - Variables like `blog` are substituted during creation
